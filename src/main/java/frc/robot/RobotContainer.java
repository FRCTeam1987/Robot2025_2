    ...
    private void configureBindings() {
        ...
        DRIVETRAIN.setDefaultCommand(
            ...
            DRIVETRAIN.applyRequest(() ->
                DRIVE.withVelocityX(-JOYSTICK.getLeftY() * MAX_SPEED) // Drive forward with negative Y (forward)
                    .withVelocityY(-JOYSTICK.getLeftX() * MAX_SPEED) // Drive left with negative X (left)
                    .withRotationalRate(-JOYSTICK.getRightX() * MAX_ANGULAR_RATE) // Drive counterclockwise with negative X (left)
            )
        );
