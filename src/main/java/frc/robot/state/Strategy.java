...
public class Strategy {
  ...
  static List<List<FieldPosition>> levelPriorities = List.of(level4Priority, level3Priority, level2Priority);
  ...
  public static Optional<Pair<Boolean, FieldPosition>> getNextPriorityLevelPosition(List<FieldPosition> level, int priorityCount) {
